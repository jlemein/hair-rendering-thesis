...
prepare --input woman-head.scene --output output/dbdf_black_venice.pbrt --propertyfiles base.properties dbdf-variation.props hdr-settings/venice.props --properties image_output_basename=black_dbdf,material_name=black_hair,model_hair_filename=wCurly.z,shader=dualscattering,samplingMethod=deon,pixelsamples=2,useDistantLight=#,useAreaLight=#,useInfiniteLight=
