...
#rotating model
#prepare --input woman-head.scene --output output/brunette_move_around_y.pbrt --propertyfiles base.properties rotating_model_around_y.properties --properties image_output_basename=brunette_rotating_model_around_y,material_name=brown_hair,model_hair_filename=wStraight,useDistantLight=,useAreaLight=#,useInfiniteLight=
