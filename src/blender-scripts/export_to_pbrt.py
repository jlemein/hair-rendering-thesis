bl_info = {
	"name": "Export PBRT (.pbrt)",
	"author": "Jeffrey Lemein",
	"version": (1, 0),
	"blender": (2, 5, 7),
	"api": 35622,
	"location": "File > Export",
	"description": "Export Scene to PBRT format",
	"warning": "",
	"wiki_url": "",
	"tracker_url": "",
...
class Export_objc(bpy.types.Operator, ExportHelper):
	'''Exports the scene to a PBRT file.'''
	bl_idname = "export_scene.pbrt"
	bl_label = "Export PBRT (.pbrt)"
...
def menu_func(self, context):
	self.layout.operator(Export_objc.bl_idname, text="Export PBRT (.pbrt)")
