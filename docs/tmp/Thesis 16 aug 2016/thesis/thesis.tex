...
\begin{itemize}
    \item The choice of the framework to render physics based algorithms in combination with the representation of hair strands.
    \item How to represent the voxel grid?
    \item How to deal with memory and speed requirements?
    \item The non-intuitiveness of the Marschner model parameters.
\end{itemize}
...
\section{Problem 4: The non-intuitiveness of the Marschner model parameters}
