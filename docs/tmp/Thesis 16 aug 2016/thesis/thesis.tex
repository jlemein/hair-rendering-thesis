...
\begin{tabular}{ccc}
\includegraphics[scale=0.55]{variance-results/un1.png} & \includegraphics[scale=0.55]{variance-results/is1.png} \\ 
\includegraphics[scale=0.55]{variance-results/un2.png} & \includegraphics[scale=0.55]{variance-results/is2.png} \\
\includegraphics[scale=0.55]{variance-results/un4.png} & \includegraphics[scale=0.55]{variance-results/is4.png} \\
\includegraphics[scale=0.55]{variance-results/un8.png} & \includegraphics[scale=0.55]{variance-results/is8.png} \\
\includegraphics[scale=0.55]{variance-results/un16.png} & \includegraphics[scale=0.55]{variance-results/is16.png} \\
\includegraphics[scale=0.55]{variance-results/un32.png} & \includegraphics[scale=0.55]{variance-results/is32.png} \\
\includegraphics[scale=0.55]{variance-results/un64.png} & \includegraphics[scale=0.55]{variance-results/is64.png} \\
\includegraphics[scale=0.55]{variance-results/un128.png} & \includegraphics[scale=0.55]{variance-results/is128.png} \\
\includegraphics[scale=0.55]{variance-results/un256.png} & \includegraphics[scale=0.55]{variance-results/is256.png} \\
\includegraphics[scale=0.55]{variance-results/un512.png} & \includegraphics[scale=0.55]{variance-results/is512.png} \\
...
\item Initially the variance is decreasing rapidly. When the samples per pixel become sufficiently large, then the decrease in variance becomes less and less, both for uniform sampling and for importance sampling. This can also be seen from the side by side comparison in figure~\ref{fig_side_by_side}. This is expected as you come closer to the converged result.

\item Importance sampling performs better for small amounts of samples per pixel. This is expected, because for smaller amount of samples importance sampling can do a better job at finding important samples. Eventually uniform sampling catches up as they both reach the converged image.
...
\begin{itemize}
\item Applying importance sampling for the dual scattering method does substantially reduce the noise compared to rendering using uniform sampling.
\end{itemize}
